 ...
 * El diseño es personalizado para seguir una paleta de colores moderna y azul.
 */
...
public class AgregarAlerta extends JFrame {
    ...
    private final Color ACCENT_COLOR = new Color(96, 165, 250);
    private final Color BACKGROUND_COLOR = new Color(17, 24, 39);
    private final Color SURFACE_COLOR = new Color(31, 41, 55);
    private final Color TEXT_COLOR = Color.WHITE;
    private final Color INPUT_BACKGROUND = new Color(55, 65, 81);
    private final Color CANCEL_COLOR = new Color(178, 34, 34); // Nuevo color para el botón de cancelar.
    ...
    private JPanel createFormPanel() {
        JPanel formPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2d.setColor(new Color(31, 41, 55, 180));
        ...
        // Botón para cancelar y cerrar la ventana, ahora en rojo
        ...
        mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                barColor = switch (type) {
                    case "success" -> new Color(0, 150, 60); // Verde para éxito
                    case "error" -> PRIMARY_COLOR; // Azul para error
                    default -> new Color(255, 165, 0); // Naranja para advertencia
                };
